...
**Dive into a vibrant collection of my Blender creations, where every image tells a story of creativity and skill! In this repository, you'll find an array of very thoroughly rendered images showcasing my passion for**: <br/>
...
https://github.com/user-attachments/assets/7116e337-bc04-4d3e-af87-40cb86f433cd
   ...
   <td style="vertical-align: top; width: 33.33%; padding: 10px;">
      ...
      <h6> Modeling, Lighting, UV unwrapping, Shader nodes, Physic simulation, Sculpting, Compositor nodes, Camera animation, Rendering </h6>
...
<!--========================================================================-->
  <tr>
    <!-- Cartoon Bear Character -->
    <td style="vertical-align: top; width: 33.33%; padding: 10px;">
      <h4>Cartoon Bear Character</h4>
      <h6>◉ Character Modeling  <br/> Modeling, Lighting, Texturing, Rendering, Post processing</h6>
      <img src="https://github.com/user-attachments/assets/49e3a0de-1d19-4a49-adec-4a706336fd42" alt="Cartoon Bear Character" style="width: 100%; height: auto;"/>
   </td>
...
<!--========================================================================-->
 ...
 <!--======= Old Style Well -->
   <td style="vertical-align: top; width: 33.33%; padding: 10px;">
      ...
      <h6> Game Asset, Modeling, Shader Nodes, Camera animation, Rendering </h6>
...
https://github.com/user-attachments/assets/a4fb9613-e20b-40db-9152-9288cbdab9b1
 ...
 <!--=============================================================================--> 
  <tr>
   ...
   <td style="vertical-align: top; width: 33.33%; padding: 10px;">
      ...
      <h6> Modeling, Shader Nodes, Camer animation, Rendering </h6>
 ...
 https://github.com/user-attachments/assets/4f44c739-7f1d-4fbd-9f28-6d7bd330e4ba
    ...
    <td style="vertical-align: top; width: 33.33%; padding: 10px;">
      <h4> Planet & Rocket </h4>
      <h6> Modeling, Shader Nodes, Rendering </h6>
...
<tr>
 <!-- Basic Animation -->
   <td style="vertical-align: top; width: 33.33%; padding: 10px;">
      ...
      <h6> • Transformation • Rotation • Physics <br/> All objects were prepped in advance; I just applied the animation.</h6>

https://github.com/user-attachments/assets/bddf6199-d95c-4091-9c0e-8585458db299
